...
LabelNetwork = label.propagation.community(GraphNetwork)
str(LabelNetwork)
is_hierarchical(LabelNetwork)

clusternet =cluster_label_prop(net)
plot(clusternet, net,vertex.size=13,vertex.label.cex=0.7,edge.arrow.distance=1, edge.color = "black", main = "Label Propogation Community",layout = layout.fruchterman.reingold) 
