...
clusternet =  cluster_louvain(net)
#is_hierarchical(clusternet)
#plot(clusternet, net,vertex.size=13,vertex.label.cex=0.7,edge.arrow.distance=1, edge.color = "black", main = "Louvain Community",layout = layout.fruchterman.reingold) 
